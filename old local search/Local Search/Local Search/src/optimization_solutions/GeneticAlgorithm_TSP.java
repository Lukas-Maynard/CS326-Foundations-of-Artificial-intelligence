...
public class GeneticAlgorithm_TSP extends GeneticAlgorithm<Integer> {
    ...
    public IndexOutOfBoundsException<Integer> reproduce(Individual<Integer> p1, Individual<Integer> p2){
        //TODO
        return;
    }
    ...
    public static void main(String[] args) {
        ...
        Individual<Integer> best = agent.evolve(agent.generateInitPopulation(NUM_CITIES, POPULATION_SIZE));
