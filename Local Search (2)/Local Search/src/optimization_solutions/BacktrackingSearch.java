...
import core_algorithms.CSPProblem.Variable;
...
public abstract class BacktrackingSearch <X, V> {
    ...
    public boolean AC3(Queue<Arc<X>> arcs){
        ...
        return true; // AC3 completed successfully
    }
    ...
    public boolean initAC3(){
        //create a queue that contains all the arcs; call AC3() with this queue.
